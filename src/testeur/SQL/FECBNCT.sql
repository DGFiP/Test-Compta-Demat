...
CREATE TABLE fec_<cloture> ( -- La clôture est au format AAAAMMJJ
	...
	lib_cpte_gen text NOT NULL , -- Champ "CompteLib" de l'arrêté
	...
	lib_ecriture text NOT NULL , -- Champ "EcritureLib" de l'arrêté
	...
	paiement_date date , -- Champ "DateRglt"
	paiement_mode text DEFAULT '', -- Champ "ModeRglt"
