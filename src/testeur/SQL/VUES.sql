...
SELECT balance_<cloture>.id_balance AS "ID",
 ...
 balance_<cloture>.ecr_cte_lig_gen_nid||COALESCE('-'||balance_<cloture>.num_cpt_aux,'') AS "Numéro Compte Gén-Aux",
 balance_<cloture>.ecr_cte_lig_gen_lib||COALESCE('-'||balance_<cloture>.lib_cpt_aux,'') AS "Libellé Compte Gén-Aux",
