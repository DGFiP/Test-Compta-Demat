...
CREATE TABLE fec_<cloture> ( -- La clôture est au format AAAAMMJJ
	...
	lib_cpte_gen text NOT NULL, -- Champ "CompteLib" de l'arrêté  modifie RB 2020
	...
	lib_ecriture text NOT NULL, -- Champ "EcritureLib" de l'arrêté modifie RB 2020																											CF1:OBLIGATOIRE
